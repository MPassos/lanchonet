...
?>
  <form method="post" action="fecharpedido.php"> <?php //Como ainda n�o temos controle de sess�o o pedido n�o pode ser cadastrado corretamente no banco sendo esta se��o apenas uma breve demosntra��o da funcionalidade  ?>
	<div id = "contcom">
		<table>
			<tr>
				<th>Hamburguer</th>
